...
type Poem struct {
	...
	TranslationSC  string `json:"translation_sc" db:"translation_sc" description:"译文（简体）"`
	AppreciationSC string `json:"appreciation_sc" db:"appreciation_sc" description:"赏析（简体）"`
}
